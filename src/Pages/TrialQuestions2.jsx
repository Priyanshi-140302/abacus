                                ...
                                <div className="card bg-FFEA9F border-0 rounded-3 shadow-sm mb-5">
                                    <div className="card-body p-2">
                                        <div className="d-flex justify-content-between align-items-center mb-3">
                                            <h6 className="text-000000 fw-semibold mb-0 fs-20">Q. No : 2</h6>
                                        </div>
                                        <div className="">
                                            <input
                                                type='number'
                    ...
                    <div className="modal-content">
                        ...
                        {result === 'correct' && (
                            <div className="text-center">
                                ...
                                <Link to='/congratulations' className="btn btn-submit w-100">
                                    Submit
                                </Link>
                            </div>
                        )}
...
export default TrialQuestions2